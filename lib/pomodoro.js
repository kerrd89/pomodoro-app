...
class Pomodoro {
  ...
  changeActiveTimer(n) {
    ...
    // $('.inactive-timer-js').first().addClass('active-timer');
    // $('.inactive-timer-js').first().addClass('active-timer-js');
    // $('.active-timer-js').first().addClass('inactive-timer-js');
    // $('.active-timer-js').first().addClass('inactive-timer');
    // $('.active-timer-js').first().removeClass('active-timer-js');
    // $('.active-timer-js').first().removeClass('active-timer');
  }
