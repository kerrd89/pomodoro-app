...
class Pomodoro {
  ...
  addTimer(timeLeft, currentState) {
    let timer = new Timer({timeLeft: timeLeft, currentState: currentState});
  ...
  breakTick(){
    ...
    if(this.timers[1].timeLeft <= 0) return alert('GO TAKE A POMODOODOO!!!');
